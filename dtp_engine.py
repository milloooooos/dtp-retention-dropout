...
# ============================ 编排 ============================
def run_analysis(sales, followup=None, max_k=12, mult=3, with_patient_crossref=True, preset='H1_2026', custom_start=None, custom_end=None):
    result = {}
    # 窗口信息（统一时间窗）
